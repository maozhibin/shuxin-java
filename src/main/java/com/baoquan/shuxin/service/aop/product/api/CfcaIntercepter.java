package com.baoquan.shuxin.service.aop.product.api;
...
import com.baoquan.shuxin.util.product.api.cfca.EncryptUtils;
import com.baoquan.shuxin.util.product.api.cfca.HttpUtils;
import com.baoquan.shuxin.util.product.api.cfca.SSLProtocolSocketFactory;
...
public class CfcaIntercepter {
    ...
    @Pointcut("execution(* com.baoquan.shuxin.service.impl.product.api.CfcaServiceImpl.*(..))")
    private void aspect() {
    }
