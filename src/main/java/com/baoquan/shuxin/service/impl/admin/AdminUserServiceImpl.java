...
public class AdminUserServiceImpl implements AdminUserService {
	...
	@Override
	public void addAdminUserInfo(String userName, String password, String copyPassword) {
		AdminUser adminUser = new AdminUser();
        adminUser.setUsername(userName);
        Mac sha256_HMAC;
		try {
			 sha256_HMAC = Mac.getInstance("HmacSHA256");
			 SecretKeySpec secret_key = new SecretKeySpec(userName.getBytes(), "HmacSHA256");
