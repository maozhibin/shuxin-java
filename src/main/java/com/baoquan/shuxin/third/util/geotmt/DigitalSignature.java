...
public class DigitalSignature {
     ...
     */
    public static String clientDigitalSignature(TreeMap<String, String> paraMap, TreeMap<String, String> headMap,
        ...
        String result = EncoderHandler.encode("SHA1", sb.toString());
        return p + h + result;
    }
