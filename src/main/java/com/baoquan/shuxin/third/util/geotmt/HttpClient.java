...
public class HttpClient {
    ...
    private static ThreadLocal<String> httpCookieString = new ThreadLocal<String>();
            // http 本次请求返回的cookie   getRs 用这个方法时有效
    ...
    public static void main(String[] args) {
        try {
            System.out.println(
                    getRs("http://127.0.0.1:8080/taskmeta/getview/web/o/login", "username=test1&password=test1",
                            "UTF-8", "UTF-8", "POST", 10000, 10000, null));
            String cookies = httpCookieString.get();
            System.out.println(cookies);
            System.out.println(getRs("http://127.0.0.1:8080/taskmeta/getview/web/u/getuseraction",
                    "username=test1&password=test1&uno=200002&dsign=1", "UTF-8", "UTF-8", "POST", 10000, 10000, null,
                    cookies));
    ...
    public static String getRs(String path, String params, String reqencoding,
            String respencoding, String requestMethod, Integer httpConnectTimeout, Integer httpReadTimeout,
            Map<String, String> headerMap) {
        return getRs(path, params, reqencoding, respencoding, requestMethod, httpConnectTimeout, httpReadTimeout,
                headerMap, null);
    }
    ...
    public static String getRs(String path, String params, String reqencoding,
            String respencoding, String requestMethod, Integer httpConnectTimeout, Integer httpReadTimeout,
            Map<String, String> headerMap, String cookies) {
        ...
        try {
            ...
            try {
                ...
                InputStream in = null;
                if (connection.getContentEncoding() != null && !"".equals(connection.getContentEncoding())
                        && !"null".equals(connection.getContentEncoding())) {
            ...
            // rs = rs.replace("&nbsp;", " ");
            System.out.println(
                    path + "?" + params + "@" + headerMap + "@" + cookies + ";状态码:" + state + ";gzip:" + encode
                            + ";返回结果:" + rs + ";cookies:" + ck + "##耗时:" + (System.currentTimeMillis() - a));
            return rs;
        } catch (Exception e) {
