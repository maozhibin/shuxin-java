package com.baoquan.shuxin.third.util.geotmt;
...
public final class RSAUtils {
    ...
    public static KeyPair getKeyPair() {
        if (staticKeyPair != null) {
            ...
            String RSAmodulus
                    =
                    "";
            //公钥指数
...
//            KeyFactory keyFactory = KeyFactory.getInstance("RSA/ECB/PKCS1Padding");  
    ...
    public static void main(String[] args) {
        ...
        miwen = encrypt(privateKey,
                "{\"code\":\"200\",\"data\":{\"tokenId\":\"3b5335396092dbf2da0012808a47d0df7\","
                        + "\"digitalSignatureKey\":\"0f3hcwpqlqkmnw1\"},\"msg\":\"成功\","
                        + "\"tokenId\":\"3b5335396092dbf2da0012808a47d0df7\"}");
        System.out.println(miwen);
        jiemi = decrypt(publicKey, miwen);
        System.out.println(jiemi);


        String publicKeygetModulus
                =
                "";
