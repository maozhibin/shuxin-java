...
public class JsoupUtil {
     ...
     * PC端头信息
     */
    public static final List<String> AGENTS = Arrays
            .asList(new String[] {
                    ...
                    "Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.31 (KHTML, like Gecko) Chrome/26.0.1410.43 "
                            + "Safari/537.31",
                    ...
                    "Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.8.1.12) Gecko/20080219 Firefox/2.0.0.12 "
                            + "Navigator/9.0.0.6"});
     ...
     * @param m       方法 默认POST
     * @return
     * @throws IOException 2015年5月29日 上午10:38:01
     * @author admin
     */
    public static Response getContent(String url, Map<String, String> data,
     ...
     * @param retry   重试次数 0代表不重试
     * @return
     * @throws IOException 2015年5月29日 上午10:34:22
     * @author admin
     */
    public static Response getContent(String url, Map<String, String> data,
     ...
     * @param port    代理IP端口
     * @return
     * @throws IOException 代理ip异常或者url异常怎抛异常 2015年5月29日 上午10:31:52
     * @author admin
     */
    public static Response getContent(String url, Map<String, String> data,
            Map<String, String> cookies, Method method,
     ...
     * @param retry   重试次数 0代表不重试
     * @return
     * @throws IOException 代理ip异常或者url异常怎抛异常
     * @author admin
     */
    public static Response getContent(String url, Map<String, String> data,
            Map<String, String> cookies, Method method,
        ...
        Connection conn = Jsoup.connect(url).ignoreContentType(true)
                ...
                .userAgent(AGENTS.get(new Random().nextInt(AGENTS.size())))
        ...
        if (retry > 0) {
            while (retry > 0) {
                try {
                    ...
                    res = null;
                    ioE = e;
                    System.out.println("jsoup链接失败 url:" + url + " ip:" + ip
                            + " 重试");
                }
                retry--;
                if (null != res) {
